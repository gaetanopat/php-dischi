...
$(document).ready(function () {
  ...
  $.ajax({
    ...
    'success': function success(data) {
      var dischi = JSON.parse(data); // visualizzazione normale, senza ordinamento

      visualizzazioneIniziale(dischi); // visualizzazione degli artisti nella select

      visualizzazioneArtistiSelect(dischi); // quando clicco su 'Home'
...
function visualizzazioneIniziale(dischi) {
  ...
  var template_disco_function = Handlebars.compile(album); // svuoto il container della section
...
function visualizzazioneArtistiSelect(dischi) {
  ...
  var artisti = []; // preparo un array contenente i nomi degli artisti non ripetuti
...
function ordinaAlbum(dischi) {
  // svuoto il container della section
  $('.dischi .container').empty(); // dopo aver cliccato resetto con l'option di default
